...
namespace Monarch_Hotel
{
    public class Round : Button
    {
        ...
        public int BorderRadius 
        {
            ...
            set { if (value <= this.Height) borderRadius = value; else borderRadius = this.Height; this.Invalidate(); }
        }
        [Category("Advanced Code")]
        ...
        private void Container_BackColorChanged(object se, EventArgs e)
        {
            if (this.DesignMode)
            {
                this.Invalidate();
